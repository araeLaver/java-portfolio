...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // 기존 데이터 모두 삭제하고 주요 포트폴리오 프로젝트 3개만 추가
        logger.info("Clearing existing projects and initializing with 3 featured projects...");
        projectRepository.deleteAll();
        logger.info("Cleared all existing projects.");
